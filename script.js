    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מיקודי ישראל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    websiteId: '3c4d0b90-b060-433a-8436-4655a089a71f',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3c4d0b90-b060-433a-8436-4655a089a71f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3c4d0b90-b060-433a-8436-4655a089a71f';
